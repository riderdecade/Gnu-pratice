...
class course_5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "course_5")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 200, 0.2, 0, 0)
        ...
        self.connect((self.blocks_throttle_1, 0), (self.blocks_streams_to_vector_0, 1))
...
def main(top_block_cls=course_5, options=None):
