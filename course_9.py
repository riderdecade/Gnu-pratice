...
class course_9(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "course_9", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("course_9")
        ...
        self.settings = Qt.QSettings("GNU Radio", "course_9")
        ...
        self.analog_sig_source_x_2 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 3000, 1, 0, 0)
...
def main(top_block_cls=course_9, options=None):
