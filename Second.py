...
class Second(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Second", catch_exceptions=True)
        ...
        self.freq = freq = 2*1000

        ##################################################
        # Blocks
        ##################################################
        self._samp_rate_range = Range(1*1000, 40*1000, 200, 10*1000, 200)
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, 32*1000,True)
        self.analog_sig_source_x_0 = analog.sig_source_f(10*1000, analog.GR_COS_WAVE, 2*1000, 1, 0, 0)
