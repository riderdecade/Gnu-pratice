...
class AM_emission(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "AM_emission")
        ...
        self._volume_range = Range(0, 1, 50*0.001, 300*0.001, 200)
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_fcf(decim, firdes.low_pass(1,samp_rate,samp_rate/(2*decim), 2000), 48*1000, samp_rate)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(300*0.001)
...
def main(top_block_cls=AM_emission, options=None):
