...
class course_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "course_4")
        ...
        self.connect((self.blocks_char_to_float_2, 0), (self.qtgui_time_sink_x_0, 2))
...
def main(top_block_cls=course_4, options=None):
