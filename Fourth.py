...
class Fourth(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Fourth")
        ...
        def _probe_var_probe():
          while True:
            ...
            try:
              try:
                self.doc.add_next_tick_callback(functools.partial(self.set_probe_var,val))
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 2000*probe_var, 500*0.001, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 100*0.000001, 1, 0, 0)
    ...
    def set_probe_var(self, probe_var):
        ...
        self.analog_sig_source_x_0_0.set_frequency(2000*self.probe_var)




def main(top_block_cls=Fourth, options=None):
