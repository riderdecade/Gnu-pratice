...
class course_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "course_2")
        ...
        self._frequency_options = [0, -3000, -2000, -1000, 1000]
        # Create the labels list
        self._frequency_labels = ['frequency:0', ' frequency:-3000', 'frequency:-2000', 'frequency:-1000', ' frequency:1000']
...
def main(top_block_cls=course_2, options=None):
