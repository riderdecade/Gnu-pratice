...
# Author: Solomon
# Copyright: Solomon
# GNU Radio version: v3.10.0.0git-452-gb1e7f599
...
wavfile = '/home/user/Documents/nokia_ringtone.wav'
...
class learning_fhss(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._vol_lvl_range = Range(0, 0.005, 0.0001, 0.001, 200)
        self._vol_lvl_win = RangeWidget(self._vol_lvl_range, self.set_vol_lvl, 'Volume Lvl', "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._noise_lvl_range = Range(0, 0.1, 0.01, 0, 200)
        self._noise_lvl_win = RangeWidget(self._noise_lvl_range, self.set_noise_lvl, 'Noise Lvl', "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        def _variable_function_probe_0_0_probe():
          while True:
            ...
            val = self.epy_block_0_0.change_channel(self.activate_rxer_fhss)
            try:
              try:
        ...
        def _variable_function_probe_0_probe():
          while True:
            ...
            val = self.epy_block_0.change_channel(self.activate_txer_fhss)
            try:
              try:
        ...
        self.analog_agc_xx_0 = analog.agc_ff(1e-4, 0.1, 0.1)
